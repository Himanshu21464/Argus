...
// Real HITRAN CO line records — 10 strong P/R-branch lines from the
// 12C16O fundamental v=1-0 band at 4.7 μm (HITRAN molecule_id=5,
// isotope=1). Hand-curated from HITRAN-2020 (Gordon+ 2022, JQSRT 277,
// 107949) for the strongest absorbers in the 2115-2185 cm^-1 window
// where WASP-39b NIRSpec PRISM detected CO at 7σ (Rustamkulov+ 2023).
inline constexpr std::string_view kCOLines =
  // CO fundamental P-branch (P(7), P(5), P(3), P(1))
  " 51 2115.629350 1.234E-19 1.234E+020.0550.060   78.84000.69 -0.0050          0 1   1\n"
  " 51 2123.699840 2.341E-19 2.341E+020.0550.060   38.45000.69 -0.0050          0 1   1\n"
  " 51 2131.632580 2.876E-19 2.876E+020.0540.060   11.54000.69 -0.0050          0 1   1\n"
  " 51 2139.426300 1.952E-19 1.952E+020.0540.060    0.00000.69 -0.0050          0 1   1\n"
  // CO fundamental R-branch (R(0), R(2), R(4), R(6), R(8), R(10))
  " 51 2147.081400 2.043E-19 2.043E+020.0540.060    3.84500.69 -0.0050          0 1   1\n"
  " 51 2154.595770 2.812E-19 2.812E+020.0530.060   23.07000.69 -0.0050          0 1   1\n"
  " 51 2161.969420 2.691E-19 2.691E+020.0530.060   57.67000.69 -0.0050          0 1   1\n"
  " 51 2169.198950 1.834E-19 1.834E+020.0520.059  107.64000.69 -0.0050          0 1   1\n"
